...
pub const Mat2x2 = math.Mat2x2;
pub const Mat3x3 = math.Mat3x3;
pub const Mat4x4 = math.Mat4x4;
pub const Ray = math.Ray;

/// Half-precision f16 types
pub const Vec2h = math.Vec2h;
pub const Vec3h = math.Vec3h;
pub const Vec4h = math.Vec4h;
pub const Quath = math.Quath;
pub const Mat2x2h = math.Mat2x2h;
pub const Mat3x3h = math.Mat3x3h;
pub const Mat4x4h = math.Mat4x4h;
pub const Rayh = math.Rayh;

/// Double-precision f64 types
pub const Vec2d = math.Vec2d;
pub const Vec3d = math.Vec3d;
pub const Vec4d = math.Vec4d;
pub const Quatd = math.Quatd;
pub const Mat2x2d = math.Mat2x2d;
pub const Mat3x3d = math.Mat3x3d;
pub const Mat4x4d = math.Mat4x4d;
pub const Rayd = math.Rayd;
